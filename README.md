...
* 101_Objective 1.R - prep,models and plots for objective 1 (comparision of methods) using single-season occupancy
* 201_Objective2_DataPrep.R - prep for unmarked framework for objective 2
* 202_Objective2_Models_Plots.R - dynamic occupancy models using combined data for objective 2, and plots
